...
fd_features_enable_all( fd_features_t * f ) {
  ...
  f->revise_turbine_epoch_stakes = 0;
  f->enable_poseidon_syscall = 0;
  f->timely_vote_credits = 0;
  f->remaining_compute_units_syscall_enabled = 0;
  f->enable_program_runtime_v2_and_loader_v4 = 0;
  f->require_rent_exempt_split_destination = 0;
  f->better_error_codes_for_tx_lamport_check = 0;
  f->enable_alt_bn128_compression_syscall = 0;
  f->programify_feature_gate_program = 0;
  f->update_hashes_per_tick2 = 0;
  f->update_hashes_per_tick3 = 0;
  f->update_hashes_per_tick4 = 0;
  f->update_hashes_per_tick5 = 0;
  f->update_hashes_per_tick6 = 0;
=======
#include "fd_features.h"
...
fd_feature_id_t const ids[] = {
  ...
  { .offset = offsetof(fd_features_t, revise_turbine_epoch_stakes),
  ...
  { .offset = offsetof(fd_features_t, enable_poseidon_syscall),
  ...
  { .offset = offsetof(fd_features_t, timely_vote_credits),
  ...
  { .offset = offsetof(fd_features_t, remaining_compute_units_syscall_enabled),
  ...
  { .offset = offsetof(fd_features_t, enable_program_runtime_v2_and_loader_v4),
  ...
  { .offset = offsetof(fd_features_t, require_rent_exempt_split_destination),
  ...
  { .offset = offsetof(fd_features_t, better_error_codes_for_tx_lamport_check),
  ...
  { .offset = offsetof(fd_features_t, enable_alt_bn128_compression_syscall),
  ...
  { .offset = offsetof(fd_features_t, programify_feature_gate_program),
  ...
  { .offset = offsetof(fd_features_t, update_hashes_per_tick2),
  ...
  { .offset = offsetof(fd_features_t, update_hashes_per_tick3),
  ...
  { .offset = offsetof(fd_features_t, update_hashes_per_tick4),
  ...
  { .offset = offsetof(fd_features_t, update_hashes_per_tick5),
  ...
  { .offset = offsetof(fd_features_t, update_hashes_per_tick6),
